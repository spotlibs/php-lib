...
class Kafka
{
    public const SCHEMALESS = 1; // Tidak berskema
    public const SCHEMALESS_WITH_SERDE = 2; // Tidak berskema tapi memiliki mekanisme encode dan decode
    public const SCHEMAFULL_WITH_SERDE = 3; // Berskema sekaligus memiliki mekanisme encode dan decode

    /**
     * Publish new message to Kafka topic
     *
     * @param string      $topic_name           kafka topic name
     * @param int         $schematype           kafka schema type
     * @param string|null $definitionSchemaBody schema body
     * @param string|null $definitionSchemaKey  schema key
     *
     ...
     * @param string      $topic_name   kafka topic name
     * @param int         $schematype   kafka schema type
     * @param string|null $congrup_name kafka consumer group name
     *
