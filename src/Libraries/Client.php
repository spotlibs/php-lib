...
class Client extends BaseClient
{
    ...
    public function __construct(array $config = [])
    {
        ...
        if ($meta !== null) {
            ...
            if (isset($meta->req_floor_commercial_desc) && $meta->req_floor_commercial_desc !== null) {
                $this->requestHeaders['X-Request-Floor-Commercial-Desc'] = $meta->req_floor_commercial_desc;
            }
        }
    }
